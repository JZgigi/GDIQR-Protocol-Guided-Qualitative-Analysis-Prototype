...
assert.match(ai, /repairCommonJsonPunctuation/);
assert.match(ai, /regenerating this window once as compact JSON/);
assert.match(ai, /OLLAMA_MU_BOUNDARY_MAX_TOKENS \?\? 2400/);
assert.match(ai, /OLLAMA_JSON_REPAIR_MAX_TOKENS \?\? 4096/);
